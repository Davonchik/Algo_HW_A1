...
В этом алгоритмическом проекте реализован метод Монте-Карло для приближенного вычисления площади пересечения трех заданных окружностей. Проведен экспериментальный анализ точности метода в зависимости от параметров: размеров области генерации точек и количества точек $N$.
...
5. **Сохраняем графики в файлы `first_type_plot.png` и `second_type_plot.png`**
   - Для сохранения графиков в файлы используются следующие строки кода:
     ```
